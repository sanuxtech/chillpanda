// components/WalletConnectSolana.tsx - Updated version
"use client";
...
export const WalletConnectSolana = ({ onAddressChange }: WalletConnectSolanaProps) => {
  const { connect, disconnect, publicKey, connected, connecting, wallet } = useWallet();
